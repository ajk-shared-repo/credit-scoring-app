...
# --------------------------
# Scoring Logic (heuristic, FICO-like range 300–850)
# --------------------------
def calculate_credit_score(data):
    score = 300
    # Payment history (35%)
    score += (data["payment_history_score"] / 100.0) * 185
    # Utilization (30%) — lower = better
    ...
    # Inquiries (10%) — fewer = better, max -60
...
def generate_pdf(form_data, score, category):
    ...
    for label, value in fields:
        ...
        y = _wrap(p, f"{label}: {value}", left, y, right-left)
...
if __name__ == "__main__":
    # Local dev only; Render uses Gunicorn via Start Command
